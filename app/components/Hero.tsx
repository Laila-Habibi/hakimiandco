...
function Hero() {
  return (
    <section className="relative min-h-[610px] bg-[var(--surface-warm)]">
      ...
      <div className="mx-auto grid max-w-[1440px] lg:grid-cols-[0.9fr_1.1fr]">
        <div className="relative z-10 flex items-center px-6 py-20 lg:px-16 lg:py-24">
          <div className="max-w-xl">
            <p className="mb-5 text-sm font-bold uppercase tracking-[0.18em] text-[var(--light-green)]">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row animate-fade-up">
              ...
              <Link
                href="#services"
                className="inline-flex items-center justify-center gap-3 rounded-lg border border-[var(--primary-green)] px-6 py-4 text-sm font-semibold text-[var(--primary-green)] transition hover:bg-[var(--primary-green)] hover:text-[var(--on-dark)]"
              >
        ...
        <div className="relative min-h-[450px] lg:min-h-[610px]">
          <div className="absolute inset-y-0 left-0 z-10 hidden w-33 bg-gradient-to-r from-[var(--surface-warm)] to-transparent lg:block" />
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[var(--surface-warm)]/20 to-transparent" />
        </div>
      </div>
    </section>
  );
